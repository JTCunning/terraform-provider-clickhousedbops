...
type Client interface {
	...
	RevokeGrantPrivilege(ctx context.Context, accessType string, database *string, table *string, column *string, accessObject *string, usesAccessObject bool, granteeUserName *string, granteeRoleName *string, clusterName *string) error
